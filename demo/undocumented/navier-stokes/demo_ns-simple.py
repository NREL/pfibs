"""Solves the lid-driven cavity Navier-Stokes equation with default block_structure.
...
bcs = []
bcs.append( DirichletBC(W.sub(0), noslip, boundaries, 1) )
bcs.append( DirichletBC(W.sub(0), noslip, boundaries, 2) )
bcs.append( DirichletBC(W.sub(0), noslip, boundaries, 4) )
...
problem = BlockProblem(J1, F1, X1, bcs=bcs)
...
problem.SubPCType(1,preconditoner)
