"""Solves the (Navier-)Stokes equation with schur complement and block_structure
defined. Compares block solver solution with builtin FEniCS solver."""
# -*- coding: utf-8 -*-
...
problem.SchurType("user") # A11, full, self, selfp, user
...
bc_pcd1 = DirichletBC(W.sub(2), 0.0, boundaries, 4)
...
problem.SubKSPType('p','cg')
problem.SubPCType('u','hypre')
problem.SubPCType('p',preconditoner)
# solver.setPCType('p','hypre')

### Set some ksp options ###
PETScOptions.set('ksp_monitor_true_residual')
PETScOptions.set('fieldsplit_u_ksp_converged_reason')
