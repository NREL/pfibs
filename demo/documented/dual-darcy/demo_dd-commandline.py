...
PETSc options to construct nested fieldsplits with schur complements."""
# -*- coding: utf-8 -*-
...
default_solver = {
    ...
    'fieldsplit_1_fieldsplit_2_ksp_type': 'preonly',
    'fieldsplit_1_fieldsplit_2_pc_type': 'bjacobi',
    'fieldsplit_1_fieldsplit_3_ksp_type': 'preonly',
    'fieldsplit_1_fieldsplit_3_pc_type': 'hypre',
}

## Setup block solver ##
solver = LinearBlockSolver(problem,solver=default_solver)
solver.solve()
